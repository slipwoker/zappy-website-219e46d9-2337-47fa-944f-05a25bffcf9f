    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Arik Yakobov Diamonds & Jewelry משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '219e46d9-2337-47fa-944f-05a25bffcf9f',
                    name: data.name || '',
                    email: data.email || '',
